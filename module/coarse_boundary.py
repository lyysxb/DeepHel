...
from candidate_Util import Logger, flanking_seq, file_exist, determine_repeat_boundary_v5, create_or_clear_directory, copy_files, \
...
if __name__ == '__main__':
    ...
    work_dir = args.tmp_output_dir + "/tmp"
